...
data$VH_1<- (8-data$VH_1) #create a new variable(column) ‘SC_1r’ with the reverse coded values of column ‘SC_1’. Not be subtract the items from 6 here - but this may differ depending on the scale. This value should be the highest rating on the scale plus 1 (i.e., 5 + 1 = 6)
data$VH_2<- (8-data$VH_2) #create a new variable(column) ‘SC_2r’
data$VH_3<- (8-data$VH_3) #create a new variable(column) ‘SC_3r’
data$VH_4<- (8-data$VH_4) #create a new variable(column) ‘SC_6r’
data$VH_5<- (8-data$VH_5) #create a new variable(column) ‘SC_8r’
data$VH_6<- (8-data$VH_6) #create a new variable(column) ‘SC_11r’
data$VH_7<- (8-data$VH_7) #create a new variable(column) ‘SC_11r’
data$VH_8<- (8-data$VH_8) #create a new variable(column) ‘SC_11r’
